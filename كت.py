...
#start
@xavierbot.on(events.NewMessage(pattern="^كت تويت$"))
async def start(event):
  await event.reply("مـرحبآ بكـ في بوت كت 😊❤️.!\n ارسل.\n علمود اتشوف الاوامر ارسل ` اوامر الكت `",
                    buttons=(
                      [
...
#help
@xavierbot.on(events.NewMessage(pattern="^اوامر الكت$"))
